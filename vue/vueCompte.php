						...
						<section id="MesRDV" >
							<div class="element">
								...
								foreach ($listeRDV as $row) {
									?>
									<div>
										<h3>Vous avez rendez-vous avec <?php echo utf8_decode(ucwords(strtolower($row['prenom'])) . " " . $row['nom']); ?></h3>
						...
						<section id="MesProches">
							<div class="element">
								...
								foreach ($listeProches as $row) {
									?>
									<div>
										<h3><?php echo utf8_decode(ucwords(strtolower($row['prenom'])) . " " . $row['nom']); ?> :</h3>
