...
/* CONTROLEUR MAIL : gestion de l'envoi des mails */
  class ControleurMail {
    ...
    public function envoiMailQuestion($question, $mailPro){
      ...
      //=====Déclaration des messages au format texte et au format HTML.
      $message_txt = "Bonjour, \n
      Une question ".$question." a été reçue depuis ce mail : ".$_SESSION['id']." . \n
      L'équipe de Pf-consult \n";
      ...
      <head>
      <meta charset=\"utf-8\">
      <title>Question d'un utilisateur</title>
      <style>
      @import url(http://fonts.googleapis.com/css?family=Lato:300,400,700);
      * { padding: 0;  margin: 0;  text-decoration: none;  color: black;  font-family: \'Lato\', sans-serif; list-style: none;}
      h1 { color: #4d4959; font-variant: small-caps;}
      ...
      <!-- CONTENT -->
      <div id=\"content\">
      <h1>Question d'un utilisateur</h1>
      <div>
      <p>Bonjour, </p>
      <p> Une question ".$question." a été reçue depuis ce mail : ".$_SESSION['id']." .</p>
      <p id=\"signature\">L'équipe de Pf-consult</p>
      </div>
      </div>
      </body>
      ...
      //=====Définition du sujet.
      $sujet = "Question d'un utilisateur";
      //=========
